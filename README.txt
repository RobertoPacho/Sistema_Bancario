...
a persistence unit "Banca_MovilPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Banca_Movil\pom.xml":
...
artifact ("Banca_Movil.war") is already built. You can build
